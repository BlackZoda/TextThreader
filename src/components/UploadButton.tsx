    ...
    const startSimulatedProgress = () => {
        ...
        const interval = setInterval(() => {
            setUploadProgress(prevProgress => {
                ...
                return (100 - prevProgress) * 0.01 + prevProgress;
            })
        }, 100);
    ...
    return (
        <Dropzone multiple={false} onDrop={async (acceptedFile) =>  {
            ...
            {({getRootProps, getInputProps, acceptedFiles}) => (
                <div {...getRootProps()} className="border h-64 m-4 border-dashed
                        ...
                        <label htmlFor="dropzone-file"
                            ...
                            {acceptedFiles && acceptedFiles[0] ? (
                                <div className="max-w-xs bg-white flex items-center
                                        ...
                                        outline-gray-200 divide-x divide-gray-200">
                                    <div className="pr-2 pl-2.5 py-2 h-full grid place-items-center">
                                        <File className="h-4 w-4 text-purple-500" />
                                    </div>
                                    <div className="pl-2 pr-4 py-2 h-full text-sm truncate">
                            ...
                            {isUploading ? (
                                <div className="w-full mt-4 max-w-xs mx-auto">
                                    <Progress value={uploadProgress} className="h-1 w-full bg-gray-200" />
                                </div>
                            ) : null}
                        </label>
                    </div>
