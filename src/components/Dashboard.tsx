...
const FileList = () => {
    ...
    return (
        ...
        {files && files?.length !== 0 ? (
            <ul className="mt-8 grid grid-cols-1 gap-6 divide-y divide-gray-200
            ...
            <div className="mt-16 flex flex-col items-center gap-2">
                <Ghost className="h-8 w-8 text-gray-800" />
                <h3 className="font-semibold text-xl">
                    No files uploaded yet
                </h3>
                <p>Let&apos;s get you started with uploading your first PDF.</p>
            </div>
        )}
        </>
    )
            ...
            <Link href={`/dashboard/${file.id}`}
                ...
                <div className="pt-6 px-6 flex w-full items-center
                    ...
                    <div className="h-10 w-10 flex-shrink-0 rounded-full
                            bg-gradient-to-tr from-indigo-500 via-purple-500
                            to-pink-700" /> 
